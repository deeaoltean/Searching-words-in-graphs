...
int testSuccPred(TTree* (*tree),  float score) { 						// test successor predecessor
	...
	long value;
	ASSERT(successor((*tree), maximum((*tree), (*tree)->root)) == NULL,"Successor-01");
	...
	ASSERT(predecessor((*tree), minimum((*tree), (*tree)->root)) == NULL,"Predecesor-01");
...
int testTreeListInsert(TTree **tree, float score) {
	...
	ASSERT(minimum(*tree,(*tree)->root)->prev == NULL, "InsertList-01");
	ASSERT(maximum(*tree,(*tree)->root)->end->next == NULL, "InsertList-02");
	...
	ASSERT(minimum((*tree), (*tree)->root)->prev == NULL , "InsertList-19");
	ASSERT(minimum((*tree), (*tree)->root)->prev == NULL , "InsertList-20");
	...
	ASSERT(maximum((*tree), (*tree)->root)->end->next == NULL , "InsertList-25");
	ASSERT(maximum((*tree), (*tree)->root)->next->next == NULL , "InsertList-26");
...
int testTreeListDelete(TTree **tree, float score) {
	...
	ASSERT(maximum((*tree), (*tree)->root)->end->next == NULL , "DeleteList-27");
	ASSERT(maximum((*tree), (*tree)->root)->next == NULL , "DeleteList-28");
	...
	ASSERT(maximum((*tree), (*tree)->root)->end->next == NULL , "DeleteList-32");
	ASSERT(maximum((*tree), (*tree)->root)->next == NULL , "DeleteList-33");
	...
	ASSERT(minimum((*tree), (*tree)->root)->prev == NULL , "DeleteList-37");
	...
	ASSERT(minimum((*tree), (*tree)->root)->prev == NULL , "DeleteList-41");
